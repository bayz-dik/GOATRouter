...
// BAYZ Router ${version} — generated by scripts/pack.mjs. Do not edit.
...
export function buildArtifact({ root = REPO_ROOT, outDir } = {}) {
  ...
  const manifest = {
    name: ARTIFACT_NAME,
    version,
    description: "BAYZ Router — local-first LLM router with an OpenAI-compatible gateway",
...
function main() {
  ...
  try {
    ...
    console.log("BAYZ release packaging");
  ...
  console.log("BAYZ release packaging — Phase 9J Task 4");
